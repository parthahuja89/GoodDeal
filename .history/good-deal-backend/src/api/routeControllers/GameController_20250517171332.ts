import { Game } from './../../../../.history/good-deal-backend/src/api/models/Game_20250512152053';
import { GameDeal } from './../../../../good-deal-ui/src/models/GameDeal';
...
route.get("/get-game-deal/:id", async (req: Request, res: Response) => {
  const gameId = req.params.id;
  try {
    getGameDeals(gameId)
